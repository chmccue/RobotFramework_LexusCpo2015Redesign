...
| LX 2015 Model page - Download Brochure button | 
| | [Tags] | 2015 | ie_ignore | 
| | Given user is on LX 2015 Model page | 
| | When user clicks Model Detail Page Download Brochure button | 
| | Then user views the LX 2015 Brochure | 

| LX 2015 Model page - Back to All Models button | 
| | [Tags] | 2015 | ie | 
| | Given user is on LX 2015 Model page | 
| | When user clicks Back to All Models button | 
| | Then user is taken to CPO All Models page | 

| LX 2015 page - Desktop view - review Choose Another Model Year menu | 
| | [Tags] | 2015 | ie | 
...
| LX 2014 page - Desktop view - review Choose Another Model Year menu | 
| | [Tags] | 2014 | ie | 
...
| LX 2013 page - Desktop view - review Choose Another Model Year menu | 
| | [Tags] | 2013 | ie | 
...
| LX 2011 page - Desktop view - review Choose Another Model Year menu | 
| | [Tags] | 2011 | ie | 
...
| LX 2010 page - Desktop view - review Choose Another Model Year menu | 
| | [Tags] | 2010 | ie | 
...
| LX 2009 page - Desktop view - review Choose Another Model Year menu | 
| | [Tags] | 2009 | ie | 
...
| LX 2009 Model page - Choose Another Model Year - 2009 |
| | [Tags] | 2009 | 
| | Given user is on LX 2009 Model page | 
| | When user clicks Choose Another Model Year menu | 
| | And menu expands and user selects 2009 | 
...
| LX 2015 Model page - Mobile Portrait view - Choose Another Model Year menu | 
| | [Tags] | mobile | 2015 | 
...
| LX 2015 Model page - Mobile Landscape view - Choose Another Model Year menu | 
| | [Tags] | mobile | 2015 | 
...
| LX 2015 Model page - Tablet Portrait view - Choose Another Model Year menu | 
| | [Tags] | tablet | 2015 | 
...
| LX 2015 Model page - Tablet Landscape view - Choose Another Model Year menu | 
| | [Tags] | tablet | 2015 | 
